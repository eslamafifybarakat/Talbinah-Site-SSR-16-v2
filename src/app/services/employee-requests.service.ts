...
export class EmployeeRequestsService {
  ...
  getEmployeeRequests(page?: number, perPage?: number, search?: string, locationId?: number | string, nationalityId?: number | string): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/${roots.services.employeeRequests.getAll}`, { params: params });
  }
  getEmployeeRequestItemData(queryKey: any): Observable<any> {
    return this.http.get(`${this.apiUrl}/${roots?.services.employeeRequests.getAll}/${queryKey}`);
  }
